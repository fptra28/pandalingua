...
<body class="m-0 font-sans flex">
    ...
    <div id="content" class="w-full flex flex-col ml-64 p-10 gap-5">
        ...
        <div class="w-full bg-neutral-200 p-5 rounded-xl">
            <form action="../controller/add-dictionary.php" method="post" class="flex flex-col gap-3">
                <!-- Input for Simplified -->
                <label for="simplified">Simplified:</label>
                <input type="text" id="simplified" name="simplified" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <!-- Input for Traditional -->
                <label for="traditional">Traditional:</label>
                <input type="text" id="traditional" name="traditional" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <!-- Input for Pinyin -->
                <label for="pinyin">Pinyin:</label>
                <input type="text" id="pinyin" name="pinyin" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <!-- Input for English -->
                <label for="english">English:</label>
                <input type="text" id="english" name="english" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <!-- Input for Indonesian -->
                <label for="indonesian">Indonesian:</label>
                <input type="text" id="indonesian" name="indonesian" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <!-- Submit button -->
                <button type="submit" name="submit" class="mt-10 bg-blue-500 text-white px-5 py-2 rounded-xl hover:bg-blue-900">Add Dictionary</button>
            </form>
