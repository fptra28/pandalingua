...
<body class="m-0 font-sans flex">
    ...
    <div id="content" class="w-full flex flex-col ml-64 p-10 gap-5">
        <a href="../admin-question.php?quiz_id=<?php echo htmlspecialchars($quiz_id); ?>" class="hover:underline">← BACK</a>
        <div class="flex flex-row justify-between items-center">
            <h1 class="text-2xl font-bold">Add New Question</h1>
        </div>
        <div class="w-full bg-neutral-200 p-5">
            <form action="../controller/add-Question.php" method="post" class="flex flex-col gap-3">
                <!-- Input for quiz ID (hidden) -->
                <input type="hidden" id="quiz_id" name="quiz_id" value="<?php echo htmlspecialchars($quiz_id); ?>" required>

                <!-- Input for question text -->
                <label for="question_text">Question Text:</label>
                <input type="text" id="question_text" name="question_text" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <!-- Input for options -->
                <label for="option_a">Option A:</label>
                <input type="text" id="option_a" name="option_a" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <label for="option_b">Option B:</label>
                <input type="text" id="option_b" name="option_b" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <label for="option_c">Option C:</label>
                <input type="text" id="option_c" name="option_c" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">

                <label for="option_d">Option D:</label>
                <input type="text" id="option_d" name="option_d" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl">
                ...
                <!-- Submit button -->
                <button type="submit" name="submit" class="bg-blue-500 text-white px-5 py-2 rounded-xl hover:bg-blue-900">Add Question</button>
            </form>
        </div>
    </div>
