...
<body class="m-0 font-sans flex">
    ...
    <div id="content" class="w-full flex flex-col ml-64 p-10 gap-5">
        ...
        <div class="w-full bg-neutral-200 p-5">
            <form action="../controller/addQuiz.php" method="post" class="flex flex-col gap-3">
                ...
                <textarea id="desc" name="desc" required class="border-2 border-neutral-500 px-5 py-2 rounded-xl"></textarea>

                <!-- Submit button -->
                <button type="submit" name="submit" class="bg-blue-500 text-white px-5 py-2 rounded-xl hover:bg-blue-900">Add Quiz</button>
            </form>
        </div>
    </div>
</body>
